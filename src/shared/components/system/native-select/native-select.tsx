...
type ParentInputProps = Omit<InputProps, keyof Omit<React.InputHTMLAttributes<HTMLInputElement>, 'prefix' | 'size'> | BlacklistProps>;

export type NativeSelectProps = ParentInputProps & Omit<React.SelectHTMLAttributes<HTMLSelectElement>, 'prefix' | 'size'>;
